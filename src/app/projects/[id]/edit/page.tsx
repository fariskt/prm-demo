...
const initailData: Project = {
  ...
  manager: "",
  assignees: [],
  tasks: [{ id: "", assignedTo: "", name: "", status: "", description: "" }],
  reminders: [],
};
...
const ProjectEditPage = () => {
  ...
  const [projectData, setProjectData] = useState<Project>(initailData);
  ...
  return (
    <div className="w-full mx-auto  ">
      ...
      <form
        ...
        className="max-w-3xl mx-auto bg-gray-50 p-4 rounded-2xl shadow-md"
      >
        <div className="space-y-2">
          <h4 className="text-lg my-2 font-medium">Project Information</h4>
          ...
          <div className="space-y-2">
            <h4 className="text-lg my-2 font-medium">Task Manage</h4>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1">
          ...
          <div className="">
            <h4 className="text-lg my-2 font-medium">Reminder Manage</h4>
            <div className="flex flex-col gap-1">
